...
export const GoogleIcon: React.FC<IconProps> = () => (
  <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
    ...
    />
    <path
      d="M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-1.01.68-2.29 1.08-3.71 1.08-2.86 0-5.28-1.94-6.14-4.54H1.68v2.83C3.51 19.08 7.71 23 12 23z"
      fill="#34A853"
    />
    <path
      d="M5.86 13.61C6.72 11.9 8.77 10.77 10.85 10.77c1.57 0 2.93.73 3.85 1.85l2.86-2.26C16.64 8.28 14.85 7 12 7c-3.04 0-5.64 1.93-6.59 4.52l3.45 2.09z"
      fill="#FBBC05"
    />
    <path
      d="M10.85 10.77c-.89 0-1.72-.31-2.38-.83l-2.86 2.27c1.44 2.6 3.74 4.53 6.14 4.54 1.42 0 2.7-.4 3.71-1.08l-2.86-2.77c-.92.59-2.28 1.04-3.14 1.04-2.08 0-3.92-.98-4.98-2.38z"
      fill="#EA4335"
    />
  </svg>
);
